...
struct EnvironmemtServices: ViewModifier {
    ...
    let store = Store<AppState, AppAction>(initialState: AppState(settings: SettingsState(), repostate: ReposState(), connectViewState: ConnectViewState()), appReducer: appReducer)
